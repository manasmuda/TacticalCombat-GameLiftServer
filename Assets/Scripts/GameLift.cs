...
public class GameLift : MonoBehaviour
{
    ...
    public float waitingForPlayerTime = 0.0f;
        ...
        if (initSDKOutcome.Success)
        {
            ProcessParameters processParameters = new ProcessParameters(
                (gameSession) => {
                    ...
                    System.Console.WriteLine("Game Session created ID:" +gameSession.GameSessionId);
                    System.Console.WriteLine("Game Session:" + gameSession);
